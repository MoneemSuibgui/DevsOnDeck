...
<body>
	<div
		...
		<div>
			<a href="/devs/register" class="mx-4">Dev Registration</a> 
			<a href="/orgs/register">Org Registration</a>
		</div>
	</div>
	<div class="container col-6 mt-4 card bg-info p-4 text-center">
		<h1>Welcome Back!</h1>
		<h4 class="mt-2">Let's Find You Some Candidates!</h4>
		<form:form action="/orgs/login" method="post" modelAttribute="org">
			<p>
