...
<body>
	<div
		...
		<div>
			<a href="/devs/login" class="mx-4">Dev Login</a> <a
				href="/orgs/login">Org Login</a>
		</div>
	</div>
	<div
		class="container  card bg-warning mt-4 p-5 border border-4 border-dark">
		<h1 class="text-center">Developer Sign Up</h1>

		<form:form action="/create/developer" method="post"
			...
			<div class="d-inline d-flex justify-content-between mb-3">
				...
				<form:label path="email" class="mx-3">Email</form:label>
				<form:input path="email" class="form-control mx-4" />
			</div>

			<p>
				<form:errors path="addresse" class="text-danger"></form:errors>
			</p>
			<div class="d-inline d-flex justify-content-between mb-3">
				<form:label path="addresse" class="mx-2">Adresse</form:label>
			...
			<div class="d-inline d-flex justify-content-between mb-3">
				...
				<form:label path="city" class="mx-4">City</form:label>
			...
			<div class="d-flex justify-content-around mt-4">
				...
				<input type="file" name="picture" class=" form-control mx-4" />
			</div>
			<div class="text-end mx-4">
				<button class="btn btn-success mt-2">Register</button>
			</div>
			<div class="text-center">
				<a href="#">Need to Sign Up an Organization?</a>
			</div>
